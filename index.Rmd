...
The data then needed to be filtered to only include observations located within the Continental United States In total 2957 observations were selected. These observations were then edited to only include 552 observations in order to minimize processing time.
...
This map shows the raw occurrence data that was found to be within the United States limits.This map only includes 552 data points from a total of almost 3000 possible in order to accelerate processing time.It can be seen that while bison observations are widespread across the United States, there is a preference of the species towards the western portion of the country.
