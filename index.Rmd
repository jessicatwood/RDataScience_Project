=---
title: Habitat Suitability for Bison Bison in the United States
author: Jessica Wood
...
```{r,fig.width=6,fig.height=3,fig.cap="Habitat Distribution of Bison bison Within the United Sates"}
...
Figure 3:
```{r,echo=F,fig.width=9,fig.height=6,fig.cap="Habitat Distribution of Bison bison Within The United Sates"}
predsProj <- raster::crop(preds, projPoly)
predsMsk <- raster::mask(predsProj, projPoly)
